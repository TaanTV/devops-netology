...
Terraform will perform the following actions:
  ...
  # aws_instance.for_each["Netology1"] will be created
  ...
  # aws_instance.for_each["netology2"] will be created
  + resource "aws_instance" "for_each" {
      + ami                                  = "ami-00888f2a5f9be4390"
      + arn                                  = (known after apply)
      + associate_public_ip_address          = (known after apply)
  ...
  # aws_instance.for_each["netology3"] will be created
  + resource "aws_instance" "for_each" {
      + ami                                  = "ami-00888f2a5f9be4390"
      + arn                                  = (known after apply)
      + associate_public_ip_address          = (known after apply)
  ...
  # aws_instance.for_each["netology4"] will be created
  + resource "aws_instance" "for_each" {
      + ami                                  = "ami-00888f2a5f9be4390"
      + arn                                  = (known after apply)
      + associate_public_ip_address          = (known after apply)
  ...
  # aws_s3_bucket.ubuntu will be created
